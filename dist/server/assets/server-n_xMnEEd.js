...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-Ds3TzxCn.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DCdvkUhL.js"),
    import("./start-B0j2jbzi.js"),
...
var ROUTER_BASEPATH = "dirtbikingisfun";
var SERVER_FN_BASE = "/dirtbikingisfun/_serverFn/";
